...
namespace UkolD1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            o.InitialDirectory = filePath;
            o.Filter = "Všechny soubory|*.*|Textový soubor|*.txt|csv-soubor|*.csv|xml-soubor|*.xml";
            if (o.ShowDialog() == DialogResult.OK)
            {
                fileName = o.FileName;
                textBox_CestaNazevSouboru2.Text = fileName;
                MessageBox.Show(String.Format("Zvolený soubor:\n{0}", fileName), "Informace o souboru", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void button_Kopie1_Click(object sender, EventArgs e)
        {
            if (MuzuKopirovat())
            {
                try
        ...
        private void button_Kpoie2_Click(object sender, EventArgs e)
        {
            if (MuzuKopirovat())
            {
